<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo SITE_URL; ?>admin/Sales/customerorder">Profit</a></li>
        </ol>
    </section>
                        ...
                        <div class="sl_inc_inr">
                            <div class="top_row">
                                ...
                                <div class="prft_tp_btn">
                                    <button class="top_btn">By Products</button>
                                    <button class="top_btn">By Employees</button>
                                    <button class="top_btn">By Customers</button>
                                    <button class="top_btn">By Sales Channel</button>
                                </div>
                                <div class="prft_tp_btn">
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4" style="margin-bottom:15px;">
                                                <label>Consider</label> <strong style="color:red;">*</strong>
