                    ...
                    <div class="box-header">
                        ...
                        $(document).ready(function() {
                            ...
                            $("#feesexl").bind("submit", function(event) {
                                $.ajax({
                                    ...
                                    dataType: "html",
                                    type: "POST",
                                    url: "<?php echo ADMIN_URL ;?>vendors/searchdetailreport",
                                    beforeSend: function() {
                        ...
                        <div class="form-group mar_btminner">
                            ...
                            <div class="form-group text-xs-center">
                                <input type="submit"
                                    style="background-color:#00c0ef;color:#fff;width:100px !important; margin-left: 15px;"
                                    class="btn btn4 btn_pdf myscl-btn date" value="Submit">
                                <button type="reset"
                                    style="background-color:#333;color:#fff;width:100px !important; margin-left: 15px;"
                ...
                <tbody>
                    <tr>
                        <td><a id="" style="position: absolute;top: 122px;right: 46px;"
                                ...
                                href="<?php echo ADMIN_URL ;?>vendors/exportstorereport"><i
                    ...
                    <tr>
                        <td colspan = "5" style = "text-align:center"> <b> Choose Date  for record search.... </b> </td>
