      ...
      <div class="col-md-12">
        <div class="box box-info">
          ...
          <?php echo $this->Form->create(null, [
              'url' => ['controller' => 'Template', 'action' => 'add'], // Ensure correct controller and action
          ...
          <div class="box-body">
            <div class="container-fluid">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <label for="exampleInputEmail1">Template For</label>
              ...
              <div class="form-group" style = "width: 1100px;">
                ...
                <textarea id="editor" name="body" class="form-control" placeholder="Enter directions here..." required></textarea>
              </div>
          ...
          <div class="box-footer">
            <?php echo $this->Form->submit('Update', ['class' => 'btn btn-info pull-right', 'title' => 'Add']); ?>
