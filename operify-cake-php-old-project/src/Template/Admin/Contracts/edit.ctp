      ...
      <div class="col-md-12">
        ...
        <div class="box box-info">
          ...
          <div class="box-header with-border">
            <h3 class="box-title"><i class="fa fa-plus-square" aria-hidden="true"></i>Edit Contract</h3>
          </div>
          <!-- /.box-header -->
          <!-- form start -->
            ...
            <div class="row">
              <div class="col-md-3">
                ...
                <input type="hidden" required="required" name="vendor_id" id="retail_ids"
                  value="<?php echo $users['supplier_id']; ?>">
                <?php echo $this->Form->input('supplier_id', array('class' => 'form-control secrh-retail', 'id' => 'itemname', 'type' => 'text', 'required', 'label' => false, 'placeholder' => 'Enter Supplier Name', 'value' => $supplier_name['name'], 'autofocus', 'autocomplete' => 'off')); ?>
              ...
              <div class="col-md-3">
                ...
                <?php echo $this->Form->input('title', array('class' => 'form-control', 'type' => 'text', 'required', 'label' => false, 'placeholder' => 'Enter Title', 'autofocus', 'autocomplete' => 'off', 'value' => $users['title'])); ?>
              </div>
              <div class="col-md-3">
                <label for="inputEmail3" class=" control-label" style="text-align: left !important;">Work Order <strong
                    style="color:red;">*</strong></label>
                <?php echo $this->Form->input('workorder', array('class' => 'form-control', 'type' => 'text', 'required', 'label' => false, 'placeholder' => 'Enter Work Order', 'autofocus', 'autocomplete' => 'off', 'value' => $users['workorder'])); ?>
              </div>
              <script>
              ...
              <div class="col-md-3">
                <label for="inputEmail3" class=" control-label" style="text-align: left !important;">Issue Date<strong
                    style="color:red;">*</strong></label>
                <?php echo $this->Form->input('issuedate', array('class' => 'form-control', 'id' => 'fissuedate', 'readonly', 'placeholder' => 'Date From', 'required', 'value' => date('d-m-Y', strtotime($users['issuedate'])), 'label' => false)); ?>
              ...
              <div class="col-md-3">
                <label for="inputEmail3" class=" control-label" style="text-align: left !important;">Cost <strong
                    style="color:red;">*</strong></label>
                <?php echo $this->Form->input('cost', array('class' => 'form-control', 'type' => 'text', 'required', 'label' => false, 'placeholder' => 'Enter Cost', 'autofocus', 'autocomplete' => 'off', 'value' => $users['cost'], 'onkeypress' => 'return isNumberKey(event)')); ?>
              </div>

              <div class="col-md-3">
                <label for="inputEmail3" class=" control-label" style="text-align: left !important;">Operational Cost
                  <strong style="color:red;">*</strong></label>
                <?php echo $this->Form->input('operation_cost', array('class' => 'form-control', 'type' => 'text', 'required', 'label' => false, 'placeholder' => 'Enter Operational Cost', 'autofocus', 'autocomplete' => 'off', 'value' => $users['operation_cost'], 'onkeypress' => 'return isNumberKey(event)')); ?>
              </div>
              <div class="col-md-3">
                <label for="inputEmail3" class=" control-label" style="text-align: left !important;">Labour Cost <strong
                    style="color:red;">*</strong></label>
                <?php echo $this->Form->input('labour_cost', array('class' => 'form-control', 'type' => 'text', 'required', 'label' => false, 'placeholder' => 'Enter Labour Cost', 'autofocus', 'autocomplete' => 'off', 'value' => $users['labour_cost'], 'onkeypress' => 'return isNumberKey(event)')); ?>
              </div>
              ...
              <div class="col-md-3">
                ...
                <?php echo $this->Form->input('contract_start_date', array('class' => 'form-control', 'id' => 'fdatefrom', 'readonly', 'required', 'placeholder' => 'Date From', 'value' => date('d-m-Y', strtotime($users['contract_start_date'])), 'label' => false)); ?>
              </div>
              ...
              <div class="col-md-3">
                <label for="inputEmail3" class=" control-label" style="text-align: left !important;">End Date<strong
                    style="color:red;">*</strong></label>
                <?php echo $this->Form->input('contract_end_date', array('class' => 'form-control', 'id' => 'fendfrom', 'readonly', 'required', 'placeholder' => 'Date To', 'value' => date('d-m-Y', strtotime($users['contract_end_date'])), 'label' => false)); ?>
              </div>
                      ...
                      foreach ($product as $value) {
                        ...
                        <tr id="producttr<?php echo $value['id']; ?>">
                          <td>
                            ...
                            <input type="hidden" name="finished_pro_123" value="<?php echo $value['product_id'] ?>">
                          ...
                          <td>
                            <input type="text" name="123" class="numbe" required="required" style="text-align:end;"
                              autocomplete="off" readonly value="<?php echo $value['price'] ?>">
                          </td>
                          <td>
                            <span class="fas fa-trash-alt delete-button" data-id="<?php echo $value['id']; ?>"
              ...
              <div class="col-md-12">
                <label for="inputEmail3" class=" control-label" style="text-align: left !important;">Description<strong
                    style="color:red;"></strong></label>
                <?php echo $this->Form->textarea('description', array('class' => 'form-control', 'type' => 'text', 'label' => false, 'placeholder' => 'Enter Description', 'autofocus', '', 'autocomplete' => 'off', 'value' => $users['description'])); ?>
              </div>
              ...
              <div class="col-md-12 text-right mt-2">
                ...
                echo $this->Form->submit(
                  'Edit',
                  array('class' => 'btn btn-info', 'title' => 'Edit', 'id' => 'formsubmitbtn')
                );
                ?>
              </div>
            </div>
...
<script type="text/javascript">
  ...
  //item namefinishedproduct
  var previousIds = [];
  var finishedproductIds = '<?php print_r(json_encode($finishedproduct)) ?>';
