...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      <li><a href="<?php echo SITE_URL; ?>admin/itemname"><i class="fa fa-home"></i>Home</a></li>
    </ol>
  </section>
      ...
      <div class="col-md-12">
        ...
        <div class="box box-info">
          ...
          <div class="box-header with-border">
            <h3 class="box-title"><i class="fa fa-plus-square" aria-hidden="true"></i> <?php if(isset($location['id'])){ echo 'Edit Item Name'; }else{ echo 'Create New Item Name';} ?></h3>
          </div>
          <!-- /.box-header -->
          <!-- form start -->
          ...
          <div class="box-body">
            ...
            <div class="col-sm-6 ">            
              ...
              <div class="col-sm-2">           
                <input type="checkbox" name="tax[]" value="<?php echo $value['id']; ?>"> <?php echo $value['tax_name']." ".$value['tax']."%"; ?>
              </div>
              <?php }  ?>
