 <!-- Content Wrapper. Contains page content -->
  ...
  .checkbox input[type="checkbox"]{
   ...
   <h1>
            <i class="fa fa-money"></i> Fees Collection Session Report        </h1>
                <ol class="breadcrumb">
...
//]]>
 ...
 <label>Acedamic Year<span style="color:red;">*</span></label>
   ...
   <?php 
					echo $this->Form->input('acedmicyear', array('class'=>'qualified form-control','type'=>'select', 'empty'=>'All','options'=>$acd, 'label' =>false,'id'=>'qualified')
					);
					?>
	    	...
	    	<?php echo $this->Form->input('ref_no',array('class'=>'form-control','placeholder'=>'Enter Reference No.','label' =>false)); ?>  
		           ...
		           <div class="col-sm-6" >
		 			 <b style=" display:block;">Mode :</b>    <span>&nbsp;&nbsp;&nbsp;&nbsp;<label class="checkbox-inline"><input  id="radio1" name="mode[]" checked="checked" value="CASH" onclick="return checks(this);" type="checkbox">Cash</label>
									 ...
									 <label class="checkbox-inline"><input  id="radio15" name="mode[]" value="CREDIT CARD/DEBIT CARD" onclick="return checks(this);" checked="checked" type="checkbox">Credit Card/Debit Card</label>
									 </span>   </div>   		                      		                                  
...
<label><input type="checkbox" checked  name="checkAll" id="select_all" value="1"> Select All</label>	</legend>
</div>
</div>
	 <div class="form-group">	 
<div class="col-sm-12">
...
<div class="checkbox col-sm-2"><label><input type="checkbox" 
name="selectField[]" value="<? echo "Prev. Due"; ?>" checked> &nbsp;<? echo 
...
<div class="checkbox <? if($el['name']=="Bank Cancellation Charge"){ 
	?>col-sm-2<?}else{ ?>col-sm-2<? } ?>"><label><input type="checkbox" 
	name="selectField[]" value="<? echo $el['name']; ?>" checked >&nbsp; <? echo ucwords(strtolower($el['name'])); ?></label></div>
<? } ?>

<div class="checkbox col-sm-2"><label><input type="checkbox" 
name="selectField[]" value="<? echo "Late Fee"; ?>" checked>&nbsp; <? echo 
ucwords(strtolower("Late Fee")); ?></label></div>
<div class="checkbox col-sm-2"><label><input type="checkbox" 
name="selectField[]" value="<? echo "Due Amount"; ?>" checked> &nbsp;<? echo 
"Due / Access Amount"; ?></label></div>
<div class="checkbox col-sm-2"><label><input type="checkbox" 
name="selectField[]" value="<? echo "Discount Fee"; ?>"checked>&nbsp; <? echo 
ucwords(strtolower("Discount Fee")); ?></label></div>
<div class="checkbox col-sm-2"><label><input type="checkbox" 
name="selectField[]" value="<? echo "Other Discount"; ?>" checked> &nbsp;<? 
