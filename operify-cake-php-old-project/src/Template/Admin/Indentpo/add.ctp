  ...
  <section class="content">
            ...
            <div class="form-group" style="margin-bottom:0px;">
              <div class="row">
                <div class="col-md-3">
                  ...
                  <?php echo $this->Form->input('indentid', array('class' => 'form-control', 'id' => 'indent_id', 'type' => 'text', 'value' => $newindentid, 'readonly', 'label' => false, 'placeholder' => 'Indent id', 'autofocus', 'autocomplete' => 'off')); ?>
                </div>
    ...
    $('#datepicker3').datepicker('setDate', new Date());
                ...
                <div class="col-md-3">
                  ...
                  <?php echo $this->Form->input('issued_name', array('class' => 'form-control itemqty', 'type' => 'text', 'label' => false, 'required', 'placeholder' => 'Enter Name', 'autofocus', 'autocomplete' => 'off', 'required')); ?>
                </div>
            ...
            <?php foreach ($indent_data as $val) { 
                $qty = $val['quantity'];
    ...
    $(function () {
      $('#item_id_pro').on('change', function () {
        ...
        if (itemid != "") {
          $.ajax({
            type: 'POST',
            url: '<?php echo ADMIN_URL; ?>indentpo/getdesignsheetdetails',
            data: {
              'itemid': itemid,
