...
<div class="content-wrapper">
   <section class="content-header">
      ...
      <ol class="breadcrumb">
         ...
         <li><a href="<?php echo SITE_URL; ?>admin/indentpo">Indent Manager</a></li>
      </ol>
   </section>
   <!-- content header -->
   <!-- Main content -->
                  ...
                  <div class="form-group" style="margin-bottom:0px;">
                     <div class="row">
                        ...
                        <div class="col">
                           ...
                           <a href="<?php echo SITE_URL; ?>admin/Indentpo/index" class="excelbtn btn"
                        ...
                        <div class="col">
                           ...
                           $fileurl = "admin/indentpo/add";
                           if (in_array($fileurl, $role_permissions)) { ?>
                              <a href="<?php echo SITE_URL; ?>admin/Indentpo/add"
                           ...
                           <a href="<?php echo SITE_URL; ?>admin/Indentpo/indentpoexcel" class="excelbtn btn pull-right"
   ...
   $(document).ready(function () {
      $("#mysubscription").bind("submit", function (event) {
         $.ajax({
            ...
            dataType: "html",
            type: "GET",
            url: "<?php echo ADMIN_URL; ?>indentpo/searchitem",
      ...
      $(document).on('click', '.pagination a', function (e) {
         ...
         var res = target.replace("/indentpo/searchitem", "/indentpo");
         window.location = res;
         return false;
      });
   });
