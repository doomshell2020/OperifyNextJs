                       ...
                       if(isset($requestdetails) && !empty($requestdetails)){ 
                          foreach($requestdetails as $intusr){ //pr($intusr);
                            ...
                            <?php  $gname=$this->Comman->finditems($intusr['item_id']); 
                              ...
                              $stock_avail_data = $stock_avail; //$stock_avail['stock_available'];
                              if($stock_avail_data < $intusr['item_qty']){
                                 $stock_check_data = 1;
                              }
                             ?>
                             <?php    if($stock_avail_data < $intusr['item_qty']){ ?>
                     <tr class="stock_aval">
                   <?php }else{ ?>
                     <tr class="">
                  <?php } ?>
               ...
               <div class="box-body" style="padding:10px 0px;">
                  ...
                  <div class="row" style="display: flex; align-items: end; flex-wrap:wrap;">
                     ...
                     <div class="col-md-4">
                        ...
                        <input type="hidden" name="cmobile_no" value="<?php echo $cname[0]['cmobile_no'];   ?>">
                     </div>
                     <div class="col-md-4">
                        <label for="inputEmail3" class=" control-label"
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-body">
            <h5>Total Payable Amount : <?php echo sprintf('%.2f',round($total_amount)); ?><h5>
         ...
         <input type ="hidden" name = "mode_pay" id = "mode_pay" value = "Cash">
                        ...
                        <?php echo $this->Form->input('pay_amount', array('class' => 'form-control category_id','type'=>'text','value'=>'','label'=>false,'autofocus','autocomplete'=>'off','value'=>sprintf('%.2f',round($total_amount)),'readonly')); ?>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <label for="inputEmail3" class=" control-label"
