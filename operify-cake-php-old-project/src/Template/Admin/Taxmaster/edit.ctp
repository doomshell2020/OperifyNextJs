      ...
      <div class="col-md-12">
        ...
        <div class="box box-info">
          ...
          <div class="box-header with-border">
            <h3 class="box-title"><i class="fa fa-plus-square" aria-hidden="true"></i> <?php if(isset($company['id'])){ echo 'Edit Tax Type'; }else{ echo 'Create New Tax Type';} ?></h3>
          </div>
          <!-- /.box-header -->
          <!-- form start -->
          ...
          <div class="box-body">
            ...
            <!-- <div class="form-group">
              ...
              <div class="col-sm-6">
                <?php //echo $this->Form->input('parent', array('class' => 'form-control', 'type' => 'select', 'options'=>$tax, 'label' => false, 'empty' => 'Select Parent Tax', 'autofocus', 'autocomplete' => 'off')); ?>
              </div>
            </div> -->
