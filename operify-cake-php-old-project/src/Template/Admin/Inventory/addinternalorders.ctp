<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo SITE_URL; ?>admin/Sales/customerorder">Internal Orders</a></li>
        </ol>
    </section>
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-4" style="margin-bottom:15px;">
                                    <label>Warehouse</label><strong style="color:red;">*</strong>
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab" tabindex="0">
                                ...
                                <div class="itm_inr">
                                    ...
                                    <label for="">Qty</label>
                                    <label for="">Available Committed</label>
                                    <label for="">In Transit</label>
                                ...
                                <div class="itm_inr_sec">
                                    ...
                                    <div class="sbttl">
                                        <div class="suttl_hding">
                                            <h4 style="margin: 0px !important;"> <b> Subtotal</b></h4>
                                            <span> <b> Type of Tax: <a href="">Tax</a> </b></span>
