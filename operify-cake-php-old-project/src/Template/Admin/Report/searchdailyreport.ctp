<div class="table-responsive">
	...
	<table id="" class="table table-bordered table-striped">
		<tbody>
				...
				<tr>
					...
					foreach ($mode as $k => $rt) {
						...
						if ($el == "Registration") { ?>
							...
							?>
							<td>
								<? if ($findrecipiet[0]['regfee'] && !empty($paidamount)) {
									$tot += $findrecipiet[0]['regfee'];
									$aet += $findrecipiet[0]['regfee'];
									echo $findrecipiet[0]['regfee'];
								} else {
									echo '0';
								} ?>
							</td>
						<?	} else  if ($el == "Prospectus") { ?>
							...
							?>
							<td>
								<? if ($findprospectus[0]['p_fees'] && !empty($paidamount)) {
									$tot += $findprospectus[0]['p_fees'];
									$aet += $findprospectus[0]['p_fees'];
									echo $findprospectus[0]['p_fees'];
								} else {
									echo '0';
								} ?>
							</td>
							...
							foreach ($paidamount as $key => $value) {
								...
								if ($rt == $value['mode']) {
									...
									foreach ($quas as $iteam['quarter'] => $iteam['amount']) {
										if ($el == "Admission Fee") {
											if ($iteam['quarter'] == 'Admission Fee'  && $value['student']['enroll'] <= '5974' && 1 == 1 && $value['student']['board_id'] == '1') {
											...
											if ($iteam['quarter'] == 'Caution Money' && $value['student']['enroll'] <= '5974' && 1 == 1 && $value['student']['board_id'] == '1') {
											...
											if ($iteam['quarter'] == 'Development Fee' && $value['student']['enroll'] <= '5974' && 1 == 1 && $value['student']['board_id'] == '1') {
			...
			<tr>
				<td><strong style="color:green;">Grand Total</strong> : <b><?php $amounttyys = money_format('%!i', $tyys); echo $amounttyys; ?></b></td>
			</tr>
