            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-plus-square" aria-hidden="true"></i>Create New EMD</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <label for="inputEmail3" class=" control-label" style="text-align: left !important">DD/Cheque/BG No.</label>
                                <?php echo $this->Form->input('bankguaranteeno', array('class' => 'form-control', 'type' => 'text', 'label' => false, 'autofocus',  'autocomplete' => 'off', 'placeholder' => 'DD/Cheque/BG No.', 'required')); ?>
                            </div>
                            <div class="col-md-3" id="board-name">
                                ...
                                <?php echo $this->Form->input('board_name', array('class' => 'form-control', 'type' => 'text', 'label' => false, 'autofocus', 'placeholder' => 'Board Name', 'autocomplete' => 'off')); ?>
                            </div>

                            <div class="col-md-3">
                                <label for="inputEmail3" class=" control-label" style="text-align: left !important">Favour Name</label>
                                <?php echo $this->Form->input('favour_of', array('class' => 'form-control', 'type' => 'text', 'label' => false, 'autofocus', 'placeholder' => 'Favour Name', 'autocomplete' => 'off')); ?>
                            </div>
                            ...
                            <div class="col-md-3" id="PO-name">
                                ...
                                <?php echo $this->Form->input('po_no', array('class' => 'form-control', 'type' => 'text', 'label' => false, 'autofocus',  'placeholder' => 'PO. No. / Tender No.', 'autocomplete' => 'off')); ?>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <?= $this->Form->input('datefrom', ['class' => 'form-control', 'placeholder' => 'Date', 'id' => 'datefrom', 'required', 'label' => false]); ?>
                            </div>

                            <div class="col-md-3">
                                <label class="control-label">Valid Upto</label>
                                <?= $this->Form->input('validupto', ['class' => 'form-control', 'readonly', 'placeholder' => 'Valid Upto', 'id' => 'validupto',  'label' => false]); ?>
                            </div>

                            <div class="col-md-3">
                                <label class="control-label">Claim Date</label>
                                <?= $this->Form->input('claim_upto', ['class' => 'form-control', 'readonly', 'placeholder' => 'Claim Date', 'id' => 'claim_upto', 'label' => false]); ?>
                            </div>

                            <div class="col-md-3">
                                <label class="control-label">Extension Upto</label>
                                <?= $this->Form->input('extenstionupto', ['class' => 'form-control', 'readonly', 'placeholder' => 'Extension Upto', 'id' => 'extenstionupto', 'label' => false]); ?>
                            </div>

                            <div class="col-md-3" id="lastdate_section">
                                <label class="control-label">Last Date of Supply</label>
                                <?= $this->Form->input('lastdate', ['class' => 'form-control', 'readonly', 'placeholder' => 'Last Date of Supply', 'id' => 'lastdate', 'label' => false]); ?>
                            </div>

                            <div class="col-md-3">
                                <label for="inputEmail3" class=" control-label" style="text-align: left !important">BG Release On/After</label>
                                <?= $this->Form->input('relese_date', ['class' => 'form-control', 'id' => 'relese_date', 'placeholder' => 'BG Release On/After', 'readonly',  'label' => false]); ?>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <?php echo $this->Form->input('contect_per', array('class' => 'form-control', 'type' => 'text', 'label' => false, 'autofocus', 'placeholder' => 'Contect Person Name',  'autocomplete' => 'off')); ?>
                            </div>
                            <div class="col-md-3">
                                <label for="inputEmail3" class=" control-label" style="text-align: left !important">Remark</label>
                                <?php echo $this->Form->input('remark', array('class' => 'form-control', 'type' => 'text', 'label' => false, 'autofocus', 'placeholder' => 'Remark',  'autocomplete' => 'off')); ?>
                            </div>
                            ...
                            ?>
                            <div class="col-md-3">
                                <label for="inputEmail3" class=" control-label" style="text-align: left !important">Remark By</label>
                                <?php echo $this->Form->input('remark_by', array('class' => 'form-control', 'type' => 'text', 'label' => false, 'autofocus', 'readonly', 'value' => $remark_by, 'autocomplete' => 'off')); ?>
                            </div>
                        </div>
                        <script>
                            $(function() {
                                const dateFields = ['#datefrom', '#validupto', '#extenstionupto', '#claim_upto', '#lastdate', '#relese_date'];
