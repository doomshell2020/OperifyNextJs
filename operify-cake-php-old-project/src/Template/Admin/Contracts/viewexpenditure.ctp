                            ...
                            <tbody>
                                ...
                                foreach ($designsheetitems as $designitem) {
                                    ...
                                    foreach ($indents as $indentitem) {
                                        $itemname = $this->Comman->getitemname($indentitem['item_id']);
                                        ...
                                        $totalindentcost += $indentitemcost;
                                        ?>
                                <tr>
                                    <td>
                                        <?php echo $indentitem['indentpo_id']; ?>
                                    </td>
                                    <td>
                                        <?php echo date('d-M-Y', strtotime($indentitem['created'])) ?>
                                    </td>
                                    <td>
                                        <?php echo $itemname['item_name']; ?>
                                    </td>
                                    <td style="text-align:right;">
                                        <?php echo sprintf('%.2f', $indentitem['item_qty']); ?>
                                    </td>
                                    <!-- <td><a class="viewgrndetails"
                                            href="<?php echo SITE_URL; ?>admin/goodsreceived/viewgrndetail/<?php echo $grnitem['goods_id']; ?>">
                                            <?php echo $grnitem['goods_id'] . '(' . date('d-M-Y', strtotime($grnitem['issue_date'])) . ')'; ?>
                                        </a></td> -->
                                        <td><a class="viewgrndetails"
                                            href="<?php echo SITE_URL; ?>admin/goodsreceived/viewgrndetail/<?php echo $grnitem['goods_id']; ?>">
                                    ...
                                    <td style="text-align:right;">
                                        <?php echo sprintf('%.2f', $indentitemcost); ?>
                                    </td>
                                </tr>
                                <?php $counter++;
                                    }
                                ...
                                <tr>
                                    ...
                                    <th style="text-align:right;"><?php echo sprintf('%.2f', $totalindentcost); ?></th>
                                </tr>
                            </tbody>
                        </table>
