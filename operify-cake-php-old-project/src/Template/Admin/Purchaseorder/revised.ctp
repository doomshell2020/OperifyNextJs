        ...
        <div class="box box-info">
          ...
          <div class="box-body">
                ...
                <table id="customers">
                  ...
                  <tbody id="product_containes">
                    ...
                    foreach ($poitems as $value) {
                      $totalBasePrice += $value['item_base_price'];
                      $totalTaxes += $value['item_tax_amt'];
                    ...
                    ?>
                      ...
                      <tr class="video_details ">
                        ...
                        <td width="8%"><input type="text" onkeypress='return isNumberKey(event)' name="pitemquantity[]"
                            class="form-control itemQtyCount newquan quntt<?php echo $i; ?>" id="quan" autocomplete='off' required
                        ...
                        <td width="10%"><input style="text-align: right;" type="text" maxlength="10" name="pitemrate[]"
                            class="form-control itemUnitPrice filterme newpitra pitraa<?php echo $i; ?>" id="pitemrate<?php echo $i; ?>"
                        ...
                        <td width="10%">
                          <input style="text-align: right;" type="text" name="pitemamount[]"
                            class="form-control totalBasePrice newtamo pitama<?php echo $i; ?>" id="pitemamount<?php echo $i ?>"
                        ...
                        <td width="10%">
                          <input style="text-align: right;" type="text" name="pitemtax[]"
                            value="<?php echo formatDecimal($value['item_tax_amt']); ?>"
                        ...
                        <td width="25%">
                          <input style="text-align: right;" type="text" name="totalamount[]" readonly
                            class="form-control totalProductAmount newtamso totalamount<?php echo $i; ?>" id="totalamount<?php echo $i; ?>"
                            value="<?php echo formatDecimal($value['item_total_amount']); ?>">
                        </td>
                        <td>
                  ...
                  <tfoot>
                    ...
                    <tr class="titlerow" style="background-color: #c8c8c8;">
                      <td colspan="6" class="text-right" style="font-weight:bold;font-size:16px;">
                        Net Amount (&#x20b9;)
                      </td>
                      <td style="font-weight: bold; text-align: right;" class="totala1">
                        <?php echo formatCurrency($totalBasePrice); ?>
                      </td>
                      <td></td>
                      <td style="font-weight: bold; text-align: right;" class="totala2">
                        <?php echo formatCurrency($totalTaxes); ?>
                      </td>
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <label for="inputEmail3">Payment Term<strong
                    style="color:red;"></strong></label>
              ...
              <div class="col-sm-6">
                <label for="inputEmail3">Remark<strong style="color:red;"></strong></label>
