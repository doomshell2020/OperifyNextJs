...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-money"></i> Store Collection Report
        </h1>
        <ol class="breadcrumb">
                    ...
                    <div class="box-header">
                        ...
                        $(document).ready(function() {
                            ...
                            $("#feesexl").bind("submit", function(event) {
                                $.ajax({
                                    ...
                                    dataType: "html",
                                    type: "POST",
                                    url: "<?php echo ADMIN_URL ;?>solditems/searchdetailreport",
                                    beforeSend: function() {
                        ...
                        <div class="form-group mar_btminner">
                            ...
                            <div class="form-group text-xs-center">
                                <input type="submit"
                                    style="background-color:#00c0ef;color:#fff;width:100px !important;margin-left: 15px;margin-top: 25px;"
                                    class="btn btn4 btn_pdf myscl-btn date" value="Submit">
                                <button type="reset"
                                    style="background-color:#333;color:#fff;width:100px !important;margin-left: 15px;margin-top: 25px;"
        ...
        <div class="table-responsive" id="updt">
            <table id="" class="table table-bordered table-striped">
                <tbody>
                    <tr>
                    <td>
                        <a id="" style="position: absolute;top: 122px;right: 46px;" class="btn btn-info btn-sm pull-right" target="_blank"  href="<?php echo ADMIN_URL ;?>solditems/exportstorereport"><i  class="fa fa-file-excel-o" aria-hidden="true"></i> Export Excel</a>
                    </td>
                    </tr>
                 
                    <tr>
                        <td><b> Receipt Insert Date </b>
                        </td>
                        <td><b>CASH</b></td>
                        <td><b>CHEQUE</b></td>
                        <td><b>Online</b></td>
                    ...
                    <tr>
                        <td colspan = "6" style = "text-align:center"> <b> Choose Date  for record search.... </b> </td>
