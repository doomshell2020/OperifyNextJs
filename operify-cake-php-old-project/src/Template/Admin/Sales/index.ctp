                  ...
                  <div class="form-group" style="margin-bottom:0px;">
                     <div class="row">
                        <div class="col">
                           ...
                           <?php echo $this->Form->input('po_id', array('class' => 'form-control ', 'type' => 'text', 'label' => false, 'autofocus', 'autocomplete' => 'off', 'placeholder' => 'Enter Name')); ?>
                        </div>
                        <div class="col">
                        ...
                        <div class="col">
                           <input type="submit" style="background-color:#00c0ef; color:#fff;margin-top:23px;width: 56px !important;" id=""
                              class="btn btn4 btn_pdf myscl-btn date" value="Search">

                           <a href="<?php echo SITE_URL; ?>admin/production/index" class="excelbtn btn"
                              style="background-color:#00c0ef; !important; margin-top: 23px; color:#fff;width: 53px !important;">Reset</a>
                        </div>
                        <div class="col">
                  ...
                  <table class="table table-bordered table-striped" width="100%">
                     <thead>
                        ...
                        <tr>
                           ...
                           <th rowspan="2" width="4%">PO No.</th>
                           <th rowspan="2" width="13%">Contract Name</th>
                           <th rowspan="2" width="13%">Machine Name</th>
                           ...
                           <th rowspan="2" width="6.50%">Total Man Power</th>
                           <?php if ($rolepresent == 105) { ?>
                        ...
                        if (isset($production_data) && !empty($production_data)) {
                           foreach ($production_data as $intusr) {
                              ...
                              <tr>
                                 ...
                                 <td>
                                 <a class="viewproductiondetails" href="<?php echo SITE_URL; ?>admin/production/viewproductiondetails/<?php echo $intusr['po_id']; ?>"><?php echo $intusr['po_id']; ?></a>
                                 </td>
                                 <td>
