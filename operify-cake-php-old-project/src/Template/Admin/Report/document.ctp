  ...
  <div class="row" >
      <div class="col-xs-12">
        <div class="box" >
            ...
            <div style="text-align:right"><a id="" style="margin-right: 15px; margin-top: 10px;" class="btn btn-info btn-sm" href="<?php echo ADMIN_URL ;?>report/documentexcel"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Excel</a></div>
            <div class="box-body">
