            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-plus-square" aria-hidden="true"></i>Create New Payment</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <?php echo $this->Form->input('particular', array('class' => 'form-control', 'type' => 'text', 'label' => false, 'autofocus',  'autocomplete' => 'off', 'placeholder' => 'Particular Name', 'required')); ?>
                            </div>
                            <div class="col-md-3" id="board-name">
                                ...
                                <?php echo $this->Form->input('consignee', array('class' => 'form-control', 'type' => 'text', 'label' => false, 'autofocus', 'placeholder' => 'Consignee', 'autocomplete' => 'off')); ?>
                            </div>

                            <div class="col-md-3">
                                <label for="inputEmail3" class=" control-label" style="text-align: left !important">PO No.</label>
                                <?php echo $this->Form->input('po_no', array('class' => 'form-control', 'type' => 'text', 'label' => false, 'autofocus', 'placeholder' => 'PO No.', 'autocomplete' => 'off')); ?>
                            </div>

                            <div class="col-md-3" id="PO-name">
                                <label for="inputEmail3" class=" control-label" style="text-align: left !important">Invoice No.</label>
                                <?php echo $this->Form->input('invoice', array('class' => 'form-control', 'type' => 'text', 'label' => false, 'autofocus',  'placeholder' => 'Invoice No.', 'autocomplete' => 'off')); ?>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <?= $this->Form->input('datefrom', ['class' => 'form-control', 'placeholder' => 'Date', 'id' => 'datefrom', 'required' => true, 'label' => false]); ?>
                            </div>
                           
                            <div class="col-md-3">
                                <label class="control-label">Bill Dispatch Date</label>
                                <?= $this->Form->input('bill_dis_date', ['class' => 'form-control', 'readonly', 'placeholder' => 'Bill Dispatch Date', 'id' => 'validupto',  'label' => false]); ?>
                            </div>


                            <div class="col-md-3">
                                <label for="inputEmail3" class=" control-label" style="text-align: left !important">Bill Amount</label>
                                <?php echo $this->Form->input('amount', array('class' => 'form-control', 'type' => 'text', 'label' => false, 'autofocus',  'placeholder' => 'Bill Amount', 'autocomplete' => 'off', 'required')); ?>
                            </div>
