<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo SITE_URL; ?>admin/Sales/customerorder">Transfers</a></li>
        </ol>
    </section>
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-4" style="margin-bottom:15px;">
                                    <label>Source Warehouse</label><strong style="color:red;">*</strong>
                                    <?php echo $this->Form->input('contact_no', array('class' => 'form-control', 'type' => 'number',  'label' => false, 'required', 'type' => 'text', 'maxlength' => '11')); ?>
                                </div>

                                <div class="col-sm-4" style="margin-bottom:15px;">
                                    <label>Traget Warehouse</label><strong style="color:red;">*</strong>
                                    <?php echo $this->Form->input('contact_no', array('class' => 'form-control', 'type' => 'number',  'label' => false, 'required', 'type' => 'text', 'maxlength' => '11')); ?>
                                </div>
                                <div class="col-sm-4" style="margin-bottom:15px;">
                                    <label>Project</label>
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab" tabindex="0">
                                ...
                                <div class="itm_inr">
                                    ...
                                    <label for="">Qty </label>
                                    <label for="">Stock ( Source Whs) </label>
                                    <label for="">Stock ( Target Whs) </label>
                                ...
                                <div class="itm_inr_sec">
                                    ...
                                    <div style="border-bottom: 1px solid;" class="sbttl">
                                ...
                                <div class="btm_lbl">
                                    <label for="">Overhead expenses</label>
                                    <input type="text">
                                    <label for="">Distribute</label>
                                    <input type="text">
                                </div>
                            </div>
