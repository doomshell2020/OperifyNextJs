...
<div class="tableContainer " style=" border:1px solid #ccc !important;">
  ...
  <div class="tableHeader">
    <p style="text-align:center;font-size:15px;"><b>Bid Details</b></p>
    <table>
      <tr>
        <td><b>Bid No. :-</b>
          <?php echo $bidDetails['id']; ?>
        </td>
 ...
 <p style="text-align:center;font-size:15px;"><b>Products</b></p>
  <div class="table-responsive" style="padding: 10px;">
    <table class="table-bordered" cellpadding="3">
      ...
      <tbody>
        <?php foreach ($bidItemDeatails as $value) {
          ...
          $costprice = $value['item_qty'] * $value['item_price_bid'];
        ?>
          ...
          <tr>
            ...
            <td style="text-align:right;">
              <?php echo number_format((float) $value['item_price_bid'], 2, '.', ''); ?>
            </td>
            <td style="text-align:right;">
            ...
            <td style="text-align:right;">
              <?php echo number_format((float) $value['item_tax_amt_bid'], 2, '.', ''); ?>
            </td>
            <td style="text-align:right;">
              <?php echo number_format((float) $value['item_total_amount_bid'], 2, '.', ''); ?>
            </td>
          </tr>
        <?php $t++;
          $totalamaunt1 += $value['item_total_amount_bid'];
        } ?>
        <tr>
          <td colspan="5" style="text-align:right;"><b></b></td>
          <td colspan="4" style="text-align:right;"><b>Total Amount :-</b>
            <?php echo number_format((float) $totalamaunt1, 2, '.', ''); ?>
          </td>
        </tr>
      </tbody>
    </table>
