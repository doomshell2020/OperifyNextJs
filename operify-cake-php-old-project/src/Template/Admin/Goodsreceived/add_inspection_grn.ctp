<div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
         <li><a href="<?php echo SITE_URL; ?>admin/goodsreceived/grninspection"><i class="fa fa-home"></i>Home</a></li>
      </ol>
   </section>
   <!-- Main content -->
                  ...
                  <div class="form-group" style="margin-bottom:0px;">
                     <div class="row">
                        ...
                        <div class="col-sm-3" style="margin-bottom:15px;">
                           <label for="inputEmail3">Inspection No. <strong style="color:red;">*</strong></label>
                           <?php echo $this->Form->input('inspection_no', array('class' => 'form-control', 'id' => 'bill_no', 'type' => 'text', 'label' => false, 'autofocus', 'empty' => 'Enter Inspection No', 'autocomplete' => 'off', 'readonly', 'value' => $inspectionNo)); ?>
                        </div>


                        <!-- <div class="col-sm-3" style="margin-bottom:15px;">
                           <label for="inputEmail3">Vendor<strong style="color:red;">*</strong></label>
                           <?php echo $this->Form->input('vendor_name', array('class' => 'form-control', 'id' => 'bill_no', 'type' => 'text', 'label' => false, 'autofocus', 'empty' => 'Enter Vendor', 'autocomplete' => 'off', 'readonly')); ?>
                        </div> -->
