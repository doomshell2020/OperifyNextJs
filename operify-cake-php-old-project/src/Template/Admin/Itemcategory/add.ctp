          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <label for="inputEmail3" class="control-label">Item Category Name<strong style='color:red;'>*</strong></label>
                <?php echo $this->Form->input('category_name', array('class' => 'form-control', 'type' => 'text', 'required', 'label' => false, 'placeholder' => 'Enter Item category name', 'autofocus', 'autocomplete' => 'off')); ?>
              </div>
            
              <div class="col-sm-4 ">
              <label for="inputEmail3" class="control-label">Description<strong style='color:red;'>*</strong></label>
                <?php echo $this->Form->input('description', array('class' => 'form-control','type'=>'textarea','required','label'=>false,'placeholder'=>'Description','autofocus','autocomplete'=>'off')); ?>
              </div>
            </div>
          </div>
          <!-- /.box-body -->
