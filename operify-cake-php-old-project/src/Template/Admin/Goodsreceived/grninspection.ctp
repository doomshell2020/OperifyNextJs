...
<div class="content-wrapper">
   <section class="content-header">
      ...
      <ol class="breadcrumb">
         ...
         <li><a href="<?php echo SITE_URL; ?>admin/Goodsreceived">Inspection GRN</a></li>
      </ol>
   </section>
   <!-- content header -->
   <!-- Main content -->
                  ...
                  <div class="form-group">
                     <div class="row">
                        ...
                        <div class="col">
                           ...
                           ?>
                           <a href="<?php echo SITE_URL; ?>admin/goodsreceived/add_inspection_grn"
                              class="btn btn-success pull-right m-top10"
                              style=" margin-top: 23px; color:#fff; padding:6px 10px;"><i
                                 class="fa fa-plus"></i>&nbsp;Add</a>
                           <?php // } 
                           ?>
                           <a href="<?php echo SITE_URL; ?>admin/goodsreceived/grninspectionexcel" class="excelbtn btn pull-right"
                     ...
                     <tbody>
                        ...
                        if (isset($goodsreceived) && !empty($goodsreceived)) {
                           foreach ($goodsreceived as $intusr) {
                              ...
                              $po = $this->Comman->getpoqty($intusr['po_id']);
                              $remain = $this->Comman->goodsrecivied($intusr['po_id'], $intusr['id']);
                              $getpo = $this->Comman->getPurchaseOrder($intusr['po_id']);

                        ?>
                              <tr>
                                 <td>
                                    <?php echo $intusr['inspection_id']; ?>
                                 </td>

                                 <td>
                                    <a class="viewgrndetails"
                                       href="<?php echo ADMIN_URL; ?>purchaseorder/viewpodetail/<?php echo $intusr['po_id'] . "/" . $getpo['is_revised'] . "/" . $getpo['id']; ?>">
                                       <?php echo $intusr['po_id']; ?>
                                    </a>
                                 </td>
