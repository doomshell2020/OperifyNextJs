                  ...
                  <tbody>
                     <?php $page = $this->request->params['paging']['']['page'];
                        ...
                        if(isset($temp_item) && !empty($temp_item)){ 
                          foreach($temp_item as $intusr){ //pr($intusr);
                            ?>
                     ...
                     <tr>
                        ...
                        <td>    <div style ="display:flex;align-items:center"> <?php echo ucfirst($intusr['additem']['item_name']); ?>
                    <?php/*  if($intusr['group_type']){
                                    $find_group_name = $this->Comman->findgroupitemstore($intusr['category_id'],$intusr['group_type'],$intusr['branch_name']); ?>
                                   <label style = "margin-left:20px">
                                      <?php echo   ucfirst($intusr['group_type']); ?> 
                                   </label>
                                   ...
                                   <?php //foreach($find_group_name as $value){ ?>
                  ...
                  <?php if($temp_item_top){ ?>
                        ...
                        <td style = "width:75%">
                            ...
                            <?php foreach($temp_item_top as $topval){ //pr($topval); ?>
                                            <option value = "<?php echo $topval['id']; ?>"><?php echo $topval['additem']['item_name']; ?></option>
                                            <?php } ?>
                     </select>  
...
var branch_name = '<?php echo $this->request->session()->read('Auth.User.db'); ?>';
          ...
          $.ajax({
               ...
               data: {
                   'category_id': category_id,'category_qty': category_qty,'branch_name': branch_name
               },
