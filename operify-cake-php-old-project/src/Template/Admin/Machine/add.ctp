                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php echo $this->Form->input('machine_name', array('class' => 'form-control', 'type' => 'text', 'label' => false, 'placeholder' =>'Enter Machine Name', 'autofocus', 'autocomplete' => 'off','required',)); ?>
                                </div>
