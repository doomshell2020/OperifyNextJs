  ...
  $(document).ready(function () {
    $("#mysubscription").bind("submit", function (event) {
      ...
      $.ajax({
        ...
        dataType: "html",
        type: "POST",
        url: "<?php echo ADMIN_URL; ?>purchaseorder/addsupplier",
...
<div class="alert alert-success alert-dismissible" style="display:none;" role="alert"> <button type="button"
    class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>Supplier
    ...
    <div class="form-group">
      <div class="row">
        ...
        <div class="col-sm-4" style="margin-bottom:15px;">
          <label>Supplier Name</label> <strong style="color:red;">*</strong>
          <?php echo $this->Form->input('name', array('class' => 'form-control', 'id' => 'title', 'placeholder' => 'Supplier Name', 'label' => false, 'required')); ?>
        </div>

        <div class="col-sm-4" style="margin-bottom:15px;">
          <label>Contact No</label><strong style="color:red;">*</strong>
          <?php echo $this->Form->input('contact_no', array('class' => 'form-control', 'type' => 'number', 'placeholder' => 'Contact Number', 'label' => false, 'required', 'maxlength' => '10')); ?>
        ...
        <div class="col-sm-4" style="margin-bottom:15px;">
          ...
          <?php echo $this->Form->input('pancard_number', array('class' => 'form-control pancard', 'type' => 'text', 'maxlength' => '15', 'label' => false, 'placeholder' => 'PAN No.', 'required', 'autocomplete' => 'off', 'id' => 'pan_no')); ?>
        ...
        <div class="col-sm-4" style="margin-bottom:15px;">
          ...
          <label class="radio-inline">
            <input type="radio" name="vendortype" class="mode radio-inline checkstr" value="Vendor">&nbsp;Vendor
          </label>
          <label class="radio-inline">
            <input type="radio" name="vendortype" class="mode radio-inline checkstr" value="Customer">&nbsp; Customer
          </label>
          <label class="radio-inline">
            <input type="radio" name="vendortype" class="mode radio-inline checkstr" value="Transporter">&nbsp;
            Transporter
          </label>
        </div>
