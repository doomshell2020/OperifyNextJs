          ...
          <div class="box-header">
            ...
            <div class="box-body">    
              ...
              <?php if($intusr['status']=='Y'){ 
                ...
                ,"onClick"=>"javascript: return confirm('Are you sure do you want to delete this location record')"]); ?>
                          ...
                          <?php
                            if($intusr['parent']==0){
                              ...
                              ?>
              <?php   $sub_location_count = $this->Comman->findsub_location($intusr['id']);  
                          // echo $sub_location_count; die;
                           ?>
                           (<a href= "<?php echo SITE_URL; ?>admin/itemlocation/viewsublocation/<?php echo $intusr->id; ?>"> <?php echo $sub_location_count; ?></a>)
                           &nbsp;<?php
                          //  if($intusr['parent']==0){
